 ...
 */
final class Version20230729103748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuario_local (local_id INT NOT NULL, usuario_id INT NOT NULL, INDEX IDX_9608E2F65D5A2101 (local_id), INDEX IDX_9608E2F6DB38439E (usuario_id), PRIMARY KEY(local_id, usuario_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE menu_producto (menu_id INT NOT NULL, producto_id INT NOT NULL, INDEX IDX_8BEA4383CCD7E912 (menu_id), INDEX IDX_8BEA43837645698E (producto_id), PRIMARY KEY(menu_id, producto_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE menu_photo (id INT AUTO_INCREMENT NOT NULL, menu_id INT NOT NULL, photo_path VARCHAR(255) NOT NULL, INDEX IDX_851BA77FCCD7E912 (menu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE informacion CHANGE telefono telefono INT NOT NULL, CHANGE descripcion descripcion LONGTEXT NOT NULL, CHANGE calle calle VARCHAR(255) NOT NULL, CHANGE localidad localidad VARCHAR(255) NOT NULL, CHANGE ciudad ciudad VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE fotos_informativas fotos_informativas VARCHAR(1000) NOT NULL, CHANGE local_id local_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE producto CHANGE nombre_producto nombre_producto VARCHAR(255) NOT NULL, CHANGE informacion_producto informacion_producto LONGTEXT NOT NULL, CHANGE precio_producto precio_producto VARCHAR(255) NOT NULL, CHANGE foto_producto foto_producto VARCHAR(1000) NOT NULL, CHANGE menus_id menus_id INT NOT NULL, CHANGE estilo estilo VARCHAR(255) NOT NULL, CHANGE informacion_id informacion_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE usuario_local');
        $this->addSql('DROP TABLE menu_producto');
        ...
        $this->addSql('ALTER TABLE informacion CHANGE local_id local_id INT DEFAULT NULL, CHANGE telefono telefono INT DEFAULT NULL, CHANGE descripcion descripcion TEXT DEFAULT NULL, CHANGE calle calle VARCHAR(255) DEFAULT NULL, CHANGE localidad localidad VARCHAR(255) DEFAULT NULL, CHANGE ciudad ciudad VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE fotos_informativas fotos_informativas VARCHAR(1000) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE producto CHANGE menus_id menus_id INT DEFAULT NULL, CHANGE informacion_id informacion_id INT DEFAULT NULL, CHANGE nombre_producto nombre_producto VARCHAR(255) DEFAULT NULL, CHANGE informacion_producto informacion_producto TEXT DEFAULT NULL, CHANGE precio_producto precio_producto VARCHAR(255) DEFAULT NULL, CHANGE foto_producto foto_producto VARCHAR(1000) DEFAULT NULL, CHANGE estilo estilo INT DEFAULT 0');
